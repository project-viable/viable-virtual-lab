...
## Set to the `DragComponent` currently being held, if it exists.
var held_drag_component: DragComponent = null
...
# When a body `b` enters an `InteractableArea` and `held_drag_component.body` is equal to `b`, that
