...
var speed: float = 500
var curr_slide_type: String = "BPAE"
var curr_slide_variation: String = "A1"
var curr_channel: String = "DAPi"
var curr_zoom_value: String = "10x"
...
func _on_macro_panel_button_press(button_value: String) -> void:
	curr_zoom_value = button_value
	var image_path: String = "res://Images/ImageCells/{curr_slide_type}/{curr_slide_variation}/{curr_channel}/{curr_zoom_value}.jpg"
	
	#Godot doesn't have f strings, so using .format
	image_path = image_path.format({
		"curr_slide_type": curr_slide_type, 
		"curr_slide_variation": curr_slide_variation, 
		"curr_channel": curr_channel, 
		"curr_zoom_value": curr_zoom_value
	})

	$CellImage/Sprite2D.texture = load(image_path)
