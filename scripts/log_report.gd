...
func append_to_string(data: String, event_name: String) -> void:
	report_data[event_name] += data

## Append a string to an array value.
func append_to_array(data: String, event_name: String) -> void:
	report_data[event_name].push_back(data)
